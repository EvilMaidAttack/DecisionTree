...
class DecisionTreeNode(NodeMixin):
    ...
    def __init__(self, data, criterion=None, criterion_value=None, attribute=None, decision_rule=None, parent=None, children=None):
        ...
        Args:
            ...
            attribute (string): The attribute this Node will use for splitting
